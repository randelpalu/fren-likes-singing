  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-6 py-2 text-slate-600 items-center">
        ...
        <button className="button-icon hover:text-orange-600 hover:scale-110" onClick={handlePrev}>
        ...
        {isPlaying
          ? <button className="button-icon hover:text-orange-600 hover:scale-110" onClick={handleTogglePlay}>
        ...
        <button className="button-icon hover:text-orange-600 hover:scale-110" onClick={handleNext}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12">
