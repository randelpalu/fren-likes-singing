  ...
  return(
    <li className={`${styles.track} ${(index === currentTrackIndex) ? 'bg-slate-300' : ''}`}>
      ...
      {isPlaying && index === currentTrackIndex
        ? <button className="button-icon text-slate-400 md:hover:text-orange-400 md:hover:scale-110 transition duration-300
        hover:text-slate-600 hover:scale-100 active:text-orange-400 active:scale-110" onClick={handleClick}>
